...
namespace Runic.Content.Imbues
{
    ...
    // User uses a large(20) amount of soul to stop and focus for awhile to heal a % of hp
    // if the user is hit while focusing they do not heal and spent soul is not regained
    // yes its the healing move in hollowknight
